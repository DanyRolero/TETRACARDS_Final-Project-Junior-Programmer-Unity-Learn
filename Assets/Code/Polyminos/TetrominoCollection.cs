...
{   
    ...
    private void InitializeCollection()
    {
        ...
        tetrominos[3] = new Tetromino(1, 0, 0, 1, 1, 1, 2, 1, IdShape.T);
        tetrominos[4] = new Tetromino(0, 0, 1, 0, 2, 0, 1, 1, IdShape.T);
        tetrominos[5] = new Tetromino(0, 0, 0, 1, 0, 2, 1, 1, IdShape.T);
        tetrominos[6] = new Tetromino(0, 1, 1, 0, 1, 1, 1, 2, IdShape.T);

        tetrominos[7] = new Tetromino(0, 0, 1, 0, 1, 1, 2, 1, IdShape.S);
        tetrominos[8] = new Tetromino(1, 0, 0, 1, 1, 1, 0, 2, IdShape.S);
        
        tetrominos[9] = new Tetromino(1, 0, 2, 0, 0, 1, 1, 1, IdShape.Z);
        tetrominos[10] = new Tetromino(0, 0, 0, 1, 1, 1, 1, 2, IdShape.Z);

        tetrominos[11] = new Tetromino(0, 1, 1, 1, 2, 1, 2, 0, IdShape.J);
        tetrominos[12] = new Tetromino(0, 0, 1, 0, 2, 0, 0, 1, IdShape.J);
        tetrominos[13] = new Tetromino(0, 0, 0, 1, 0, 2, 1, 2, IdShape.J);
        tetrominos[14] = new Tetromino(0, 0, 1, 0, 1, 1, 1, 2, IdShape.J);

        tetrominos[15] = new Tetromino(0, 0, 0, 1, 1, 1, 2, 1, IdShape.L);
        tetrominos[16] = new Tetromino(0, 0, 1, 0, 2, 0, 2, 1, IdShape.L);
        tetrominos[17] = new Tetromino(1, 0, 1, 1, 1, 2, 0, 2, IdShape.L); 
        tetrominos[18] = new Tetromino(0, 0, 1, 0, 0, 1, 0, 2, IdShape.L);
    }
